;=================================================================================
FUNCTION CircleHough,xpts,ypts,THRESHOLD=thresh,NCIRCLES=ncircles,$
...
;
;REFERENCE
;http://www.cis.rit.edu/class/simg782.old/talkHough/circleHoughPrograms.html#CircleHoughLink
;-
