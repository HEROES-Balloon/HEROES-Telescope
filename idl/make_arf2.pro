PRO make_arf2, nshells, offaxis_angle, balloon_altitude, source_elevation, arffile,$
 summed_eff_area=summed_eff_area, use_cawh_calc=use_cawh_calc, arf = arf

;This code computes the diagonal, non-detector components of the response. 
...
; simulated results at various off-axis ;angles.
